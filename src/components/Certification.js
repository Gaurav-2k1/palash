...
const Certification = () => {
    return (
        <div className='h-full  py-5 w-full bg-slate-800 flex flex-col items-center '>
            <div className='md:text-3xl'>Certification</div>
            <div className="flex flex-wrap justify-center gap-5 mt-10 md:w-4/5">
                {

                    detaildata.certification.map((data, i) => {
                        return (
                            <div key={i} className="flex flex-col items-center gap-4 w-min px-5 text-center
                                ...
                                <span className="text-white md:w-52  text-base md:text-lg ">{data.name}</span>
