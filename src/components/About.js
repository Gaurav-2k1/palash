    ...
    <div className="h-full w-full bg-slate-800">
      ...
      <div className="flex  flex-col md:flex-row justify-around px-2">
        <div className="w-full md:w-1/2 md:h-full flex flex-col items-center">
          <div className='w-1/2 md:w-2/3 h-full bg-slate-600 md:rounded-3xl rounded-full p-2 md:-rotate-2 md:flex md:flex-col md:items-center md:p-4'>
            <Image src={imga} className='overflow-hidden md:rounded-2xl w-full  md:w-96 md:h-96 rounded-full ' alt="" />
          </div>
        </div>
        <div className='w-full md:w-1/2 flex flex-col gap-4 items-center md:items-start md:pl-10 py-5'>
          ...
          <span className='text-white text-base  w-full md:w-2/3 text-justify px-2'>
