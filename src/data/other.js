...
export const detaildata = {
    ...
    responsibilities: [
        ...
        "Replicated 3rd Party tool insights in Power BI to get detailed insights quickly with additional features for better user experience.",
        ...
        "Created Confluence and SharePoint page to capture report details and backend modelling & Scheduling.",
        "Led for conducting knowledge sharing sessions for Team members.",
    ...
    awards: [
        ...
        "Star Award 2021: Recognition for carrying out PI Project and Migration Project.",
        "Spot Award 2020: Recognition for automation of a report in webi to decrease human efforts.",
    ],
    achievement: [
        "Good Team Player",
        "Analytical thinking and Problem-Solving Skills",
        "Highly Motivated to know more about latest technology, new software and products.",
        "Respect the timeline to deliver with quality solution.",
